...
public class Scroller {
	...
	public boolean scrollScrollView(final ScrollView view, int direction){
	...
	public boolean scrollScrollToView(final ScrollView view, final int sx, final int sy){
	...
	public void scrollScrollViewAllTheWay(final ScrollView view, final int direction) {
